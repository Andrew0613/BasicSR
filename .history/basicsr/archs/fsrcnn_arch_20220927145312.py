...
class FSRCNN(nn.Module):
    ...
    def __init__(self, in_channels=1, out_channels=1, d=56,s=12,m=4, upscale_factor=3,init_type="kaiming"):
        ...
        layers = []
        feature_extraction_layer = [nn.Conv2d(in_channels, d, kernel_size=5, padding=2),nn.PReLU(d)]
        ...
        deconv_layer = [nn.ConvTranspose2d(d, out_channels, kernel_size=9, stride=upscale_factor, padding=3, output_padding=0),nn.PReLU(out_channels)]
