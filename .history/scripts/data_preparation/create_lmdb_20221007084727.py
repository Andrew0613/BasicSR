...
def prepare_keys_vimeo90k(folder_path, train_list_path, mode):
    ...
    return img_path_list, keys
def create_lmdb_for_t91(is_residual=False):
    ...
    if is_residual:
        name = "residual"
    # HR images
    folder_path = 'datasets/T191/label_x3bilinear'
    lmdb_path = 'datasets/T191/T191_train_HR'+name+'_sub.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
    ...
    # LRx3 images
    folder_path = 'datasets/T191/data_x3bilinear'
    lmdb_path = 'datasets/T191/T191_train_LR'+name+'_bilinear_X3_sub.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
...
if __name__ == '__main__':
    ...
    if dataset == 'div2k':
        ...
        create_lmdb_for_t91(is_residual=False)
    else:
