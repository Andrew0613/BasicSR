...
if __name__=="__main__":
    dataset_paths = ["/ssd/home/uguser/pyd/dataset/image_SR/T91","dataset/image_SR/General100"]
    output_path = "datasets/T91"
    # dataset_path = "datasets/Set14/original"
    # output_path = "datasets/Set14/modified"
    generate_train_img(dataset_paths,output_path,phase="train",is_residual=True)
