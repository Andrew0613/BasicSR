...
def generate_train_img(dataset_path,output_path,up_scale=3,patch_size=11,is_residual=False,phase="train"):
    """
    生成训练集
    ...
    # h5_file.close()
    #这种方式保存太过于耗时
    data_name = "train_x{}_residual".format(up_scale) if is_residual else "train_x{}".format(up_scale)
    #删除文件夹
...
if __name__=="__main__":
    ...
    generate_train_img(dataset_path,output_path,phase="test",is_residual=True)
